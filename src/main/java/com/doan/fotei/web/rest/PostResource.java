...
import com.doan.fotei.repository.PostRepository;
...
/**
 * REST controller for managing {@link com.doan.fotei.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
     ...
     */
    @PutMapping("/posts/{id}")
    public ResponseEntity<Post> updatePost(@PathVariable(value = "id", required = false) final String id, @RequestBody Post post)
    ...
    public ResponseEntity<Post> partialUpdatePost(@PathVariable(value = "id", required = false) final String id, @RequestBody Post post)
        throws URISyntaxException {
            ...
            .map(
                existingPost -> {
                    ...
                    if (post.getSource() != null) {
                        existingPost.setSource(post.getSource());
                    }
                    if (post.getDisable() != null) {
                        existingPost.setDisable(post.getDisable());
                    }
